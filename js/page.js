$.ajax({
    ...
    success: function(data) {
               ...
               for (var facultad in data) {
                 $('#facultades').append("<div class=\"col-lg-3 col-md-4 col-xs-8 thumb\"> <a href=\"http://www.paradisecity.me:8088/manage.html/#"+data[facultad]._id+"\"><img src="+data[facultad].properties.imgSrc+" alt=\"\" /></a>  \
