$.ajax({
    ...
    success: function(data) {
               ...
               for (var facultad in data) {
                 $('#facultades').append("<div class=\"col-lg-3 col-md-4 col-xs-8 thumb\"> <a href=\"http://ivr0.myqnapcloud.com:8082/admin#"+data[facultad]._id+"\"><img src="+data[facultad].properties.imgSrc+" alt=\"\" /></a>  \
